...
def plot_boreholes(ax, **kwargs):
    rad = 2
    ax.plot([10, 10], [-10, -elevation_5198], **kwargs)
    ax.plot([26, 26], [-20, -elevation_5000], **kwargs)
    ax.plot([10 - rad, 10 + rad], [-depth_5198, -depth_5198], **kwargs)
    ax.plot([26 - rad, 26 + rad], [-depth_5000, -depth_5000], **kwargs)
