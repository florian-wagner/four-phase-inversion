...
grid = ImageGrid(fig, 111, nrows_ncols=(6, 3), axes_pad=[0.1, 0.03],
...
# fig.savefig("4PM_joint_inversion.pdf", dpi=150, bbox_inches="tight")
fig.savefig("%s_two_columns_bucha3.pdf" % scenario, dpi=500, bbox_inches="tight", pad_inches=0.0)
for ax in grid.axes_column[2]:
    ax.set_visible(False)
fig.savefig("%s_two_columns_bucha2.pdf" % scenario, dpi=500, bbox_inches="tight", pad_inches=0.0)
for ax in grid.axes_column[1][2:-1]:
    ax.set_visible(False)
fig.savefig("%s_two_columns_bucha1-2.pdf" % scenario, dpi=500, bbox_inches="tight", pad_inches=0.0)
for ax in grid.axes_column[1][2:]:
    ax.set_visible(False)
fig.savefig("%s_two_columns_bucha1-1.pdf" % scenario, dpi=500, bbox_inches="tight", pad_inches=0.0)
for ax in grid.axes_column[1]:
    ax.set_visible(False)
fig.savefig("%s_two_columns_bucha1.pdf" % scenario, dpi=500, bbox_inches="tight", pad_inches=0.0)
