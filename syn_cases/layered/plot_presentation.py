...
grid = ImageGrid(fig, 111, nrows_ncols=(6, 3), axes_pad=[0.15, 0.03],
                 share_all=True, add_all=True, cbar_location="right",
                 cbar_mode="edge", cbar_size="5%", cbar_pad=0.08, aspect=True)
...
fig.savefig("agu/%s_two_columns.pdf" % scenario, dpi=500, bbox_inches="tight", pad_inches=0.0)
